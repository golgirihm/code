...
public:
    ...
    void setupUi(QMainWindow *MainWindow)
    {
        ...
        b_equals->setGeometry(QRect(370, 200, 31, 71));
        l_input = new QLineEdit(centralWidget);
        l_input->setObjectName(QStringLiteral("l_input"));
        l_input->setGeometry(QRect(20, 80, 341, 20));
