#include "mylayout.h"
myLayout::myLayout(QWidget *parent, int margin, int spacing)
    : QLayout(parent)
{
    setMargin(margin);
    setSpacing(spacing);
...
bool myLayout::hasHeightForWidth() const
{
    return false;
}
...
QSize myLayout::calculateSize(SizeType sizeType) const
{
    QSize totalSize;
