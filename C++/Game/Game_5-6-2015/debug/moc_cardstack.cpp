...
QT_MOC_LITERAL(13, 107, 8),
QT_MOC_LITERAL(14, 116, 11),
QT_MOC_LITERAL(15, 128, 13),
QT_MOC_LITERAL(16, 142, 10)
    },
    "cardstack\0StackChanged\0\0cardstack*\0"
    "stack\0ToStandardDeck\0Shuffle\0AddCard\0"
    "card\0newCard\0Look\0position\0TopCard\0"
    "TakeCard\0TakeTopCard\0NumberOfCards\0"
    "PrintCards"
};
...
void cardstack::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        case 3: _t->AddCard((*reinterpret_cast< card(*)>(_a[1]))); break;
        case 4: { card _r = _t->Look((*reinterpret_cast< int(*)>(_a[1])));
            if (_a[0]) *reinterpret_cast< card*>(_a[0]) = _r; }  break;
        case 5: { card _r = _t->TopCard();
            if (_a[0]) *reinterpret_cast< card*>(_a[0]) = _r; }  break;
        case 6: { card _r = _t->TakeCard((*reinterpret_cast< int(*)>(_a[1])));
            if (_a[0]) *reinterpret_cast< card*>(_a[0]) = _r; }  break;
        case 7: { card _r = _t->TakeTopCard();
            if (_a[0]) *reinterpret_cast< card*>(_a[0]) = _r; }  break;
        case 8: { int _r = _t->NumberOfCards();
            if (_a[0]) *reinterpret_cast< int*>(_a[0]) = _r; }  break;
        case 9: _t->PrintCards(); break;
        default: ;
        }
